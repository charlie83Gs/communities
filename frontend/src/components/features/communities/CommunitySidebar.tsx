...
export type SidebarTab = 'wealth' | 'members' | 'invites' | 'trust-grants' | 'settings' | 'forum' | 'polls' | 'councils' | 'needs' | 'items' | 'trust-timeline' | 'health' | 'pools' | 'activity' | 'disputes' | 'contributions' | 'community-wealth' | 'members-section';
