...
export const Icon: Component<IconProps> = (props) => {
  ...
  return (
    <Switch>
      ...
      <Match when={props.name === 'document'}>
        <svg
          class={baseClass()}
          width={size()}
          height={size()}
      ...
      <Match when={props.name === 'attachment'}>
        <svg
          class={baseClass()}
          width={size()}
          height={size()}
      ...
      <Match when={props.name === 'whatsapp'}>
        <svg
          class={baseClass()}
          width={size()}
          height={size()}
      ...
      <Match when={props.name === 'refresh-cw'}>
        <svg
          class={baseClass()}
          width={size()}
          height={size()}
      ...
      <Match when={props.name === 'x-circle'}>
        <svg
          class={baseClass()}
          width={size()}
          height={size()}
      ...
      <Match when={props.name === 'check-circle'}>
        <svg
          class={baseClass()}
          width={size()}
          height={size()}
