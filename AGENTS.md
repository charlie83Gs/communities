...
**CRITICAL:** For any significant change (new features, redesigns, architectural changes), you MUST follow this workflow:
...
2. **Create Written Proposal**
   - Document the proposed changes in detail
   - Include: layout/structure, component breakdown, data requirements
   - Identify API changes needed (new endpoints, modified responses)
   - List what will be removed or deprecated
   - Present implementation phases if complex

3. **Wait for Feedback**
   - Present the proposal to the user
   - Do NOT begin implementation until feedback is received
   - Iterate on the proposal based on user input
   - Clarify any questions or concerns

4. **Agree on Final Design**
   - Confirm API contracts (routes, request/response shapes)
   - Confirm frontend structure and components
   - Confirm what existing code will be modified or removed

5. **Implement Only After Approval**
   - Once the user approves, proceed with implementation
   - Use the agreed-upon contracts for parallel agent work

**Why This Matters**: Building the right solution together is more valuable than building quickly. The proposal phase surfaces misunderstandings early, allows for better architecture decisions, and ensures both human and AI are aligned on the outcome.
